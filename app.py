...
from utils.fruits_recognition import FruitRecognizer
...
fruits_recognizer = FruitRecognizer(os.path.abspath(os.path.dirname(__file__)) + '/models/fruits_net.h5', sess, graph)
...
def recognize_fruit():
    '''
        Recibe la imagen con un string de base 64
